...
fun ScreenTimeTrendChart(
    ...
    val barColor = Color(0xFF8E24AA) // Purple
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "Screen-Time Usage (Minutes)",
            ...
            if (dataPoints.isEmpty() || dataPoints.all { it.value == 0.0 }) {
                Box(
                    ...
                    Text(
                        text = "No restricted app usage in this period",
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
            } else {
                val maxVal = max(dataPoints.maxOfOrNull { it.value } ?: 1.0, 15.0)
